...
offer_acceptance_prompt = "Please, choose one or zero of proposed offers - send only the name of its author. If no offers suits for you - return 'noone'\n{offers}"
...
participant_prompt = (
    ...
    "If you accept some of the offers - return participant's name whose offer you accept. Otherwise, return only 'Refused'"
)
